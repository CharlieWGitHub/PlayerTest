...
- (NSComparisonResult)compare:(YYTextPosition *)otherPosition
{
    ...
    if (_affinity == YYTextAffinityBackward && otherPosition.affinity == YYTextAffinityForward)
        return NSOrderedAscending;
    if (_affinity == YYTextAffinityForward && otherPosition.affinity == YYTextAffinityBackward)
        return NSOrderedDescending;
