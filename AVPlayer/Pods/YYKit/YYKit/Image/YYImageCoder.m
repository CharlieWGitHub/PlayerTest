...
{
    return (uint32_t)((value & 0x000000FFU) << 24) |
...
YYImageType YYImageTypeFromUTType(CFStringRef uti)
{
    ...
    dispatch_once(&onceToken, ^{
      dic = @{(id) kUTTypeJPEG : @(YYImageTypeJPEG),
                   (id)
              kUTTypeJPEG2000 : @(YYImageTypeJPEG2000),
              (id)
              kUTTypeTIFF : @(YYImageTypeTIFF),
              (id)
              kUTTypeBMP : @(YYImageTypeBMP),
              (id)
              kUTTypeICO : @(YYImageTypeICO),
              (id)
              kUTTypeAppleICNS : @(YYImageTypeICNS),
              (id)
              kUTTypeGIF : @(YYImageTypeGIF),
              (id)
              kUTTypePNG : @(YYImageTypePNG) };
    });
    if (!uti)
        return YYImageTypeUnknown;
